...
class App extends Component {
  ...
  deleteSong = id => {
    ...
    const updateList = songsList.filter(item => item.id !== id)
    this.setState({
      songsList: updateList,
    })
  }
    ...
    return (
      <div className="container">
        <div className="card-image">
          <h1 className="title">Ed Sheeran</h1>
          ...
          <div className="title-and-search">
            ...
            <div className="search-container">
              <input
                ...
                className="input"
              />
              <AiOutlineSearch className="button" size={18} />
            </div>
          </div>
          {length ? (
            ...
            <div className="not-found-container">
              <p className="caption">No Songs Found</p>
            </div>
          )}
        </div>
      </div>
